...
Config.Locales = {
    ...
    -- added after 19th June 2024
    
    ["admintag_exploit"] = "Tried to exploit admin tag",

    ["switch_player_spectate"] = "Left/Right Arrow Key to Switch Between Players",
    ["backspace_to_exit"] = "BackSpace to exit",
    ["spectating"] = "Spectating",
    ["god_mode_disabled"] = "[Admin Menu] God Mode Disabled",
    ["god_mode_enabled"] = "[Admin Menu] God Mode Enabled",
    ["name_enabled"] = "[Admin Menu] Names are enabled",
    ["name_disabled"] = "[Admin Menu] Names are disabled",
    ["blip_enabled"]= "[Admin Menu] Blips are enabled",
    ["blip_disabled"] = "[Admin Menu] Blips are disabled",
}