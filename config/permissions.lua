...
Config.Permissions = {
    ["fivem:2461463"] = "god", -- the role god, admin or mod should be the key from Config.GodRoles which means the values that are added in square brackets.
    -- ["fivem:2461463"] = "god",
    -- ["fivem:2461463"] = "god",
    -- ["fivem:2461463"] = "god", -- discord roles (copy the role id and paste it here) (If you want to use the discord roles, you need to add the bot token and server id in sv_perms.lua at the top)
    -- ["fivem:2461463"] = "god", -- citizenid for qbcore
    -- ["fivem:2461463"] = "god", -- charid for ESX
